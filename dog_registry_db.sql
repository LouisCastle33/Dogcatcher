...
INSERT INTO `tbl_dogs` (`dog_id`, `owner_id`, `tag_serial`, `dog_name`, `breed`, `color`, `sex`, `dog_photo`, `status`, `updated_at`, `last_sync`) VALUES
(5, 5, 'BAS-2026-6515', 'Cooper', 'Shih Tzu/Pomeranian', NULL, 'Male', 'dog_1773717307_2523.jpg', 'Home', '2026-03-17 03:15:07', NULL);
...
(5, 'Louis Castle', 'Kayhuvokan', '09615431165', 'owner_1773717307_6973.png', NULL, '2026-03-17 03:15:07');
...
CREATE TABLE `tbl_users` (
  ...
  `role` enum('Admin','Catcher','Clerk') DEFAULT 'Clerk',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_users` (`user_id`, `fullname`, `username`, `password`, `role`, `created_at`) VALUES
(1, 'Louis Castle', 'louis_castle', '$2y$10$f9UlZqBOKbs1hndVL1WRGeVM6t9Wqo2sUQnKKzpxXNM5c1hRU4RXO', 'Catcher', '2026-03-17 00:43:14'),
(2, 'Jannine Salamagos', 'jannine_salamagos', '$2y$10$VsUfKVZQi4sXKDSCHsZMI.SeebZz0Tpodcvlfs/uS1vd8MH2YxQBq', 'Admin', '2026-03-17 00:45:42');
...
--
ALTER TABLE `tbl_dogs`
  MODIFY `dog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
